...
@Entity
@Table(name = "Administrators", schema = "dbo", catalog = "moshayof")
public class AdministratorsEntity {
    ...
    public boolean equals(Object o) {
        ...
        return adminid == that.adminid && Objects.equals(username, that.username) && Objects.equals(password, that.password);
    }
